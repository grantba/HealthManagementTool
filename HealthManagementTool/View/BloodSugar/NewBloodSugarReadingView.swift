//
//  NewBloodSugarReadingView.swift
...
struct NewBloodSugarReadingView: View {
    ...
    var body: some View {
        ...
        header: {
            Text("New Blood Sugar Reading").foregroundColor(.blue).font(.system(size: 20, weight: .semibold))
        }
