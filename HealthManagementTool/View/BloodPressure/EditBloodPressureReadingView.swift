//
//  EditBloodPressureReadingView.swift
...
struct EditBloodPressureReadingView: View {
    ...
    var body: some View {
        ...
        header: {
            Text("Edit Blood Pressure Reading").foregroundColor(.blue).font(.system(size: 20, weight: .semibold))
        }
